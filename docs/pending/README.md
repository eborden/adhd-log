...
| 09  | [Trend data honesty: coverage + gaps](09-trend-data-honesty.md)           | **P1**   | Rescoped to the in-app Trends surface: "logged 22 of 30 days" coverage + unambiguous gap rendering; report-side denominator moved to 16       |
